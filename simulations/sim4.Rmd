...
ggsave("~/Desktop/conceptual/public_writing/talks/20210430/figure/multimodal_memberships_gamma.png", width = 4, height = 4.5, dpi = 600)
```
```{r}
...
ggplot(scatter_data, aes(gamma_source, gamma_target)) +
  ...
  scale_color_viridis_c() +
  theme(axis.text = element_text(size = 5))
ggsave("~/Desktop/conceptual/public_writing/talks/20210430/figure/multimodal_memberships_corr.png", width = 4, height = 4.5, dpi = 600)
```
...
ggplot(scatter_data, aes(gamma_source, gamma_target)) +
  ...
  scale_color_viridis_c() +
  theme(axis.text = element_text(size = 5))
ggsave("~/Desktop/conceptual/public_writing/talks/20210430/figure/multimodal_memberships_beta.png", width = 4, height = 4.5, dpi = 600)
```
```{r}
