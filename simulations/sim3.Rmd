...
#ggsave("~/Desktop/conceptual/public_writing/talks/20210430/figure/environment_gammas.png", p, dpi = 900, width = 6, height = 3)
```
...
ggsave("~/Desktop/conceptual/public_writing/talks/20210430/figure/environment_structure_plot.png", p, dpi = 900, height = 7, width = 6)
```
...
#ggsave("~/Desktop/conceptual/public_writing/talks/20210430/figure/environment_alignments.png", dpi = 900, width = 5.5, height = 4.5)
```
...
ggraph(G, "bipartite") +
  ...
  scale_size(range = c(.1, 5), guide = FALSE)
ggsave("~/Desktop/conceptual/public_writing/talks/20210430/figure/environments_bipartite.png", dpi = 900, width = 6, height = 3)
```
